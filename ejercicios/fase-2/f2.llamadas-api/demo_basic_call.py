...
# Claude Haiku 4.5 prices per MILLION tokens (June 2026).
# Named once at the top: if the price or model changes, one line changes.
# (This demo first ran on claude-opus-5 at 5.00/25.00 — switched to Haiku
# to keep re-runs cheap; the code is identical, only the id and prices change.)
