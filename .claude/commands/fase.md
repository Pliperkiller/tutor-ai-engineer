...
Lee `state/progress.json`, `roadmap/roadmap.yaml` y lista `state/sessions/` (los nombres `YYYY-MM-DD.md` son el historial de sesiones; ábrelas solo si necesitas saber qué tópico se trabajó cada día). Luego muestra, en este orden:
